...
Pokefã é uma plataforma contendo informações dos 151 pokemons da região de Kanto, onde o usuário poderá visualizar todos os pokemons na tela, buscar o Pokémon por nome, filtrar sua busca por tipo e por ovos e ordenar os pokemons por ordem alfabética ou numérica. Essa plataforma tambem fornece ao usuário as estatísticas sobre cada tipo de pokémon, oferecendo ao usuário informações relevantes para utilizar no jogo Pokemon Go.
[Clique aqui para acessar](link gitHub pages)


## Usuário

O Projeto foi pensado e desenvolvido para todos os jogadores de Pokemon Go e fãs de Pokemon.

### Pesquisa de usuário
A partir da pesquisa de usuários, conseguimos identificar as necessidades e tentamos atende-las da melhor forma possível. 
...
Karine, Luana e Pamela (tentar colocar os links do GitHub em cada nome)

Projeto desenvolvido para fins de aprendizado no Bootcamp da Laboratória Brasil. (colocar link da Laboratoria)
